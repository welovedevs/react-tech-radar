...
function Item(props) {
  ...
  var shortName = props.data.name.length > MAX_LENGTH ? props.data.name.substr(0, MAX_LENGTH) + "..." : props.data.name;

  var onMouseToggle = function onMouseToggle() {
    setIsHovered(!isHovered);
  };

  return /*#__PURE__*/_react.default.createElement(_Item.ItemWrapper, {
    className: "blip",
